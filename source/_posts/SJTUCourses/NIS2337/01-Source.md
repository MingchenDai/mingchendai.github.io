...
$$
D_{KL}(\lambda\mathbf{P}_1+(1-\lambda)\mathbf{P}_2\|\lambda\mathbf{Q}_1+(1-\lambda)\mathbf{Q}_2)\leq\lambda D_{KL}(\mathbf{P}_1\|\mathbf{Q}_1)+(1-\lambda)D_{KL}(\mathbf{P}_2\|\mathbf{Q}_2)
$$
